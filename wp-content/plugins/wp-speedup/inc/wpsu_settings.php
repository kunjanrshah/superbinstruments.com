...
<a href="https://profiles.wordpress.org/fahadmahmood/#content-plugins" target="_blank"><img height="160" src="<?php echo plugin_dir_url( dirname(__FILE__) ); ?>/images/mechanic_with_board.png" align="right" /></a>
  ...
  <ul>
  	<li><a href="http://androidbubble.com/blog/category/website-development/htaccess/" target="_blank">.htaccess at a Glance</a></li>
    <li><a href="http://androidbubble.com/blog/website-development/htaccess/caching-with-htaccess/" target="_blank">Caching with .htaccess</a></li>
    <li><a href="http://androidbubble.com/blog/website-development/htaccess/codeigniter-htaccess-issue-on-php-cgi-webhero-hosting/" target="_blank">htaccess issue on php cgi</a></li>
    <li><a href="http://androidbubble.com/blog/website-development/htaccess/error-reporting-on-in-htaccess/" target="_blank">Error Reporting</a></li>
    <li><a href="http://androidbubble.com/blog/website-development/htaccess/caching-with-htaccess" target="_blank">More Articles on .htaccess usage</a></li>
